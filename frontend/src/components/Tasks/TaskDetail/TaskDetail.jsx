...
function TaskDetail({ task, onClose }) {
  const { formData, handleChange, setForm, resetForm } = useTaskForm(subjects);
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      idSubject: Number(task.subject.id),
    ...
    <div className={styles.overlay}>
      ...
      >
        <div className={styles.header}>
          ...
          <span className={styles.headerTitle}>Chi tiết nhiệm vụ</span>
        </div>
        <div className={styles.content}>
          <div className={styles.taskName}>
            <label>
              <FontAwesomeIcon icon={faPenToSquare} /> Tên nhiệm vụ
            </label>
            <input
              type="text"
          ...
          <div className={styles.grid}>
            ...
            <div className={styles.group}>
              <label>
                {" "}
                <FontAwesomeIcon icon={faCircle} /> Trạng thái
              </label>
